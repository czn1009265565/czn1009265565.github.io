...
ids = [str(i) for i in range(len(character_chunks))]
character_chunks_str = [d.page_content for d in character_chunks]

chroma_client = chromadb.Client()
collection = chroma_client.create_collection(name="wiki_collection")
collection.add(
   documents=character_chunks_str,
   ids=ids
)
