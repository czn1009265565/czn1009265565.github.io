...
### Excel输入
![Excel输入](imgs/kettle/Excel输入.png)
...
![Excel工作表字段](imgs/kettle/Excel工作表字段.png)
获取字段并设置字段类型
...
JSON Path语法
![JSON Path](imgs/kettle/JSON%20Path.png)
...
1. 通过JavaScript代码构造请求体
   ![img.png](imgs/kettle/构造请求体.png)
2. 配置RestClient组件
   ![img.png](imgs/kettle/配置RestClient.png)
3. JSON input解析返回值
